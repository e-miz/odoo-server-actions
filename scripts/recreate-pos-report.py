def fix_report_pos_order(env):
    """
    Recreates pos_order_reports without duplication of order lines
    based on POS Categories for each product.
